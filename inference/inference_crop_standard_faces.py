...
bboxes[0] = max(0, bboxes[0] - 100)
bboxes[1] = max(0, bboxes[1] - 100)
bboxes[2] = min(img.shape[1], bboxes[2] + 100)
bboxes[3] = min(img.shape[0], bboxes[3] + 100)
...
save_crop_path = 'test_cropped.png'
