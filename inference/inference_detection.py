...
def main(args):
    ...
    with torch.no_grad():
        bboxes = det_net.detect_faces(img, 0.5 if args.model_name == 'insight_retina' else 0.97)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--model_name', type=str, default='retinaface_resnet50', help='retinaface_resnet50 | retinaface_mobile0.25 | insight_retina')
